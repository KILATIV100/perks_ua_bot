...
export const seedProducts = [
  ...
  { name: 'Капучино', description: null, volume: '180 мл', price: 55, category: 'Кава', type: 'MENU' as ProductType, imageUrl: null },
  { name: 'Капучино', description: null, volume: '250 мл', price: 65, category: 'Кава', type: 'MENU' as ProductType, imageUrl: null },
  { name: 'Капучино', description: null, volume: '350 мл', price: 85, category: 'Кава', type: 'MENU' as ProductType, imageUrl: null },
  ...
  { name: 'Мокачино', description: null, volume: '350 мл', price: 95, category: 'Кава', type: 'MENU' as ProductType, imageUrl: null },
